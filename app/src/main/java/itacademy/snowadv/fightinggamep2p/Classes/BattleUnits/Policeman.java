...
public class Policeman extends BattleUnit{
    ...
    public Policeman(SpritePainter spritePainter, Point location, SnapLocation snapLocation, int width) {
    ...
    public static BattleUnit getAttachedToField(Field field, Context context) {
        ...
        return new Policeman(painter, field.getBottomLeftPoint(), SnapLocation.BOTTOM_LEFT,
                field.getWidth());
